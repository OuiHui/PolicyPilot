...
type InsurancePlanPolicyUploadProps = {
  onComplete: (
...
export function InsurancePlanPolicyUpload({
  onComplete,
  onBack,
}: InsurancePlanPolicyUploadProps) {
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Upload your policy documents. We'll extract your plan information automatically.
          </p>
        </div>
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-gray-400 transition-colors cursor-pointer">
                {comprehensiveFile ? (
                  ...
                  <>
                    ...
                    <p className="text-gray-500">PDF files only - Click to browse</p>
                  </>
                )}
              </div>
            </label>
