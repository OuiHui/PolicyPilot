      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="p-6 bg-green-50 border border-green-200 rounded-lg mb-6">
          <p className="text-green-900">
            {fromAppealFlow ? (
              <>
                <strong>Next step:</strong> After saving this plan, you'll
                continue to create your appeal.
              </>
            ) : (
              <>
                <strong>Next step:</strong> Your insurance plan will be saved
                and you can use it to create appeals.
              </>
            )}
          </p>
        </div>
