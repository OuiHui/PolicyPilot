...
export function ReplyReceived({ case: caseItem, onDraftFollowup, onBack }: ReplyReceivedProps) {
  const latestReply = caseItem.emailThread.filter(e => e.type === 'received').pop();

  const insurerReply = {
    from: latestReply?.from || 'claims@healthguard.com',
    subject: latestReply?.subject || 'Re: Appeal for Claim Denial',
    date: latestReply?.date ? new Date(latestReply.date).toLocaleString() : 'October 27, 2025 at 2:34 PM',
...
${caseItem.insuranceCompany} Claims Department`
      ...
      items: [
        {
          ...
          explanation: 'They\'re referencing internal guidelines, not your policy terms. This is a common tactic to avoid honoring the actual policy language.'
        }
      ]
    },
    {
      ...
      items: [
        {
          ...
          explanation: 'They\'re applying stricter criteria than what\'s written in your policy. Your policy doesn\'t require evidence-based standards.'
        }
      ]
    },
    {
      ...
      items: [
        {
          ...
          explanation: 'This is good! They\'re informing you of escalation options. You may want to pursue this if the second appeal fails.'
        }
      ]
    }
  ];
  ...
  const highlightText = (text: string) => {
    ...
    matches.forEach(({ start, end, color }) => {
      ...
      parts.push({ text: text.substring(start, end), color });
      lastIndex = end;
    });
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            The insurance company has responded to your appeal. We've analyzed their reply below.
          </p>
        </div>
                  ...
                  return (
                    <p key={index} className="text-gray-700 leading-relaxed">
                      {parts.map((part, partIndex) => 
                        part.color ? (
                          <span key={partIndex} className={`${part.color} px-1 rounded`}>
                            {part.text}
                          </span>
                        ) : (
          ...
          <div className="space-y-6">
            <Card className="p-6">
              ...
              <p className="text-gray-600 mb-6">
                We've identified key points in their response that you should address in your follow-up.
              </p>
                  ...
                  <div key={index}>
                    ...
                    <div className="space-y-3">
                      {category.items.map((item, itemIndex) => (
                        <div key={itemIndex} className={`p-4 rounded-lg ${category.color} border-l-4 border-${category.color.replace('100', '500')}`}>
            ...
            <Card className="p-6 bg-orange-50 border-orange-200">
              ...
              <p className="text-gray-700 mb-4">
                This is a <strong>standard denial response</strong> that doesn't address the specific 
                policy conflicts you raised. They're referencing their internal guidelines instead of 
                your policy terms.
              </p>
              <p className="text-gray-700">
                <strong>Your next step:</strong> Draft a follow-up that points out they haven't 
                addressed the policy sections you cited and requests clarification on how their 
                clinical guidelines override your policy.
              </p>
            </Card>
